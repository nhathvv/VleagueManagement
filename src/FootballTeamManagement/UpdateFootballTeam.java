...
public class UpdateFootballTeam extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdateFootballTeam frame = new UpdateFootballTeam();
...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		lblNewLabel.setBounds(33, 55, 100, 30);
		...
		lblTniBng.setBounds(33, 108, 100, 30);
		...
		lblNgyThnhLp.setBounds(33, 163, 100, 30);
		...
		JLabel lblMImage = new JLabel("MãImage");
		lblMImage.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblMImage.setBounds(33, 219, 100, 30);
		...
		btn_update.setBounds(147, 279, 106, 25);
		contentPane.add(btn_update);
		
		lblThmiBng = new JLabel("Sửa đội bóng");
		lblThmiBng.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 16));
		lblThmiBng.setBounds(244, 11, 119, 23);
		...
		clear_Im.setBounds(289, 279, 106, 25);
