...
public class UpdateFootballPlayer extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdateFootballPlayer frame = new UpdateFootballPlayer();
...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		JLabel lblThmCuTh = new JLabel("Sửa thông tin cầu thủ");
		lblThmCuTh.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 15));
		lblThmCuTh.setBounds(144, 28, 195, 23);
		...
		btn_update.setBounds(131, 293, 106, 25);
		contentPane.add(btn_update);
		
		JButton btn_add_1 = new JButton("Trở lại");
		...
		btn_add_1.setBounds(284, 293, 106, 25);
